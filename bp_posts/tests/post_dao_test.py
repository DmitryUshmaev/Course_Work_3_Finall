...
class TestPostsDAO:
    ...
    def test_get_fields(self, post_dao):
        posts = post_dao.get_all()
        post = post_dao.get_all()[0]
        check_fields(post)
    ...
    def test_get_all_correct_ids(self, post_dao):
        ...
        assert pks == correct_pks, "Не совпадают полученный id"

    # Тест получения постов по pk
    ...
    def test_search_in_content_get_fields(self, post_dao):
        posts = post_dao.search_in_content("ага")
    ...
    def test_search_in_content_not_found(self, post_dao):
        posts = post_dao.search_in_content("999999")
    ...
    # Тест получения постов по имени пользователя
    ...
    def test_search_by_poster_get_fields(self, post_dao):
        posts = post_dao.get_by_poster("leo")
    ...
    def test_search_by_poster_not_found(self, post_dao):
        posts = post_dao.search_in_content("Alex")
        assert posts == [], "Should be [] for not existent substring"
